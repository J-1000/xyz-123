...
mongoose.connect('mongodb+srv://RFv3aO5lhHY1Gf0b:jRPbvZJRAw4oSWLv@cluster0.lyg7a.mongodb.net/myFirstDatabase?retryWrites=true&w=majority')
...
// 	.then(books => {
// 		console.log(`Success - added ${books.length} books to the db`)
